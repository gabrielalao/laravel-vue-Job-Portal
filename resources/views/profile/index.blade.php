             ...
             <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="experience" class="form-control" value="{{Auth::user()->profile->experience}}"></textarea>
                    ...
                    <div class="form-group">
                        <label for="">Bio</label>
                        <textarea name="bio" class="form-control" value="{{Auth::user()->profile->bio}}"></textarea>
                        @if($errors->has('bio'))
